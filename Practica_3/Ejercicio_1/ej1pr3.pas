...
procedure buscarEmpleado(var empleados: archivo; nro: str25; var pos: Integer);
var
  worker: empleado;
begin
  pos:= -1;
...
procedure borrarEmpleados(var empleados: archivo);
var
  worker: empleado; nro: str25;
  pos: Integer;
begin
  write('Ingrese el numero del empleado a borrar');
  ReadLn(nro);
  reset(empleados);
  buscarEmpleado(empleados, nro, pos);
  if (pos <> -1) then begin
